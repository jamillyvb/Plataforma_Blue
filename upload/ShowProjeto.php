<?php
include('../server.php');
require_once("../Mobile-Detect-2.8.34/namespaced/Detection/MobileDetect.php");
...
<div>
	<figure class="figura">
		...
		<a href="upload/imgs/<?php echo $_SESSION['nomeFoto'];  ?>" download><img src="upload/imgs/<?php echo $_SESSION['nomeFoto'];  ?>" alt="IMAGEM" ></a>
...
?>
	...
	<p>Artigo: <br><strong><?php echo $_SESSION['nomeArtigo']; ?></strong> </p>
	...
	?>
		...
		<?php } ?>
			...
			<a href="upload/docs/artigo/<?php echo $_SESSION['nomeArtigo']; ?>" class="" download><img src="../Vetores/cloud.svg" alt="baixar" width="30px" height="auto">  Dowload</a>
...
<?php
	...
	<p>Relatório: <br><strong><?php echo $_SESSION['nomeRelatorio']; ?></strong> </p>

	<?php	}else{ ?>

		<label for="rel" class="">Relatório do Projeto</label>
		<embed src="upload/docs/relatorio/<?php echo $_SESSION['nomeRelatorio']; ?>" id="rel" class="" type="application/pdf" width="" height=""/><br>
		...
		<?php } ?>
			...
			<a href="upload/docs/relatorio/<?php echo $_SESSION['nomeRelatorio']; ?>" class="" download> <img src="../Vetores/cloud.svg" alt="" width="30px" height="auto">  Dowload</a>
